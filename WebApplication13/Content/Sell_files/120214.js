...
var user = "sally11907@gmail.com";
var ServerLog = "//stats.sapo.vn/";
window.logging = {
...
SiteStats.prototype.getLink = function () {
    ...
    if (document.referrer == null || document.referrer == "") {
        ...
        var link = '<div style="display:none"><img src="' + ServerLog + "Delivery/Logging?SiteId=" + this.siteId + "&User=" + user + "&Url=" + document.URL + '&ReferenceUrl=Null"/></div>';
    }
    else {
        var link = '<div style="display:none"><img src="' + ServerLog + "Delivery/Logging?SiteId=" + this.siteId + "&User=" + user + "&Url=" + document.URL + "&ReferenceUrl=" + document.referrer + '"/></div>';
    }
    return link;
}
...
function getTracking() {
    var siteStats = new SiteStats(120214); 
    siteStats.draw();
